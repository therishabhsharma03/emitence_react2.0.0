    ...
    <ParallaxProvider>
      ...
      <div className="App">
        ...
        <ParallaxComponent image="/images/runwal_25_hours_emitence.webp" alignment="left" bg_align="right">
          ...
          <div className='news'>
              <p className="bodySmall">Runwal 25 Hour's is a residential project located in Thane, near Mumbai, India. It offers a range of modern apartments designed to maximize space and comfort. The project includes amenities like a clubhouse, swimming pool, fitness center, and landscaped gardens, catering to a contemporary lifestyle. Strategically positioned, it provides excellent connectivity to major parts of Mumbai and surrounding areas, making it an appealing choice for those seeking a vibrant community and convenient living.</p>
              {/* <img src="/images/dholera_news2.jpg" alt="team" className="Emitence_dholera_news" />
              <img src="/images/dholera_news1.jpeg" alt="team" className="Emitence_dholera_news" /> */}
            </div>
        </ParallaxComponent>
